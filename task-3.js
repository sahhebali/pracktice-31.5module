...
const divaided = (a) => a / 5;
const divaidedResult = divaided(50);
// console.log(divaidedResult);

/* ৩.২ তুমি দুইটা প্যারামিটার ওয়ালা একটা অ্যারো ফাংশন লিখবে। সেই ফাংশনের ভিতরে কাজ হবে। প্রত্যেকটা ইনপুট প্যারামিটার এর সাথে ২ যোগ করবে তারপর যোগফল দুইটা গুণ করবে। ক্যামনে করবে সেটা চিন্তা করে বের করার চেষ্টা করো 
 */
const twoParameter = (x, y) => {
    const sum = (x + 2) * (y + 2);
    return sum;
}
const total = twoParameter(10, 15);
// console.log(total);
...
const multiply = threeParameter(5, 6, 8);
...
const plusAndMultiply = dubbleparameter(12, 35);
console.log(plusAndMultiply);